...
$this->title = Yii::t('app', 'หนังสือรับ');
                  ...
                  'columns' => [
                   ...
                   //   [
                      ...
                      //  'value'=>function($model){
                        //    return $model->title==0?'<i class="glyphicon glyphicon-remove"></i> <span class="text-danger">Not Active</span>':'<i class="glyphicon glyphicon-ok"></i> <span class="text-success">Active</span>';
                       // }
                    //  ],
                      //'id',
                     // 'username',
                     ...
                     // [
                      //  'attribute'=>'date_book',
                     //   'filter'=>$searchModel->getItemdate_book,
                      //  'format'=>'html',
                      //  'value'=>function($model){
                      //    return $model->date_book;
                     //   }
                     // ],
