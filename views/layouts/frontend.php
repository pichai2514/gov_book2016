            ...
            <div class="pull-right">
              ...
              <div style="margin-top: 10px">
                <?php if (empty($session->get('member_id'))): ?>
                  <?php $f = ActiveForm::begin(['action' => 'index.php?r=frontend/login', 'options' => ['class' => 'form-inline']]); ?>
                ...
                <?php else: ?>
                  ...
                  <a href="index.php?r=frontend/addtocart" class="btn btn-primary">
                  ...
                  <div class="collapse navbar-collapse">
                    <ul class="navbar-nav nav">
                      <li class="first active">
                        <a href="index.php?r=frontend/index">
                          Home
                        </a>
                      </li>
                      <li>
                        <a href="index.php?r=frontend/product">
                          Product
                        </a>
                      </li>
                      <li>
                        <a href="index.php?r=frontend/about">
                          About
                        </a>
                      </li>
                      <li>
                        <a href="index.php?r=frontend/payment">
                          Payment
                        </a>
                      </li>
                    </ul>
